...
// is the same as original domain, e.g. redirect to "www.ExploitSuite.cc" from
// "ExploitSuite.cc" is allowed, but redirect to "google.com" is not allowed.
...
// is the same as original host, e.g. redirect to "www.ExploitSuite.cc" from
// "ExploitSuite.cc" is not the allowed.
