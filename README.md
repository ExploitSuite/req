...
<p align="center">
    ...
    <p align="center">
        <a href="https://github.com/ExploitSuite/req/actions/workflows/ci.yml?query=branch%3Amaster"><img src="https://github.com/ExploitSuite/req/actions/workflows/ci.yml/badge.svg" alt="Build Status"></a>
        <a href="https://goreportcard.com/report/github.com/ExploitSuite/req/v3"><img src="https://goreportcard.com/badge/github.com/ExploitSuite/req/v3" alt="Go Report Card"></a>
        <a href="https://pkg.go.dev/github.com/ExploitSuite/req/v3"><img src="https://pkg.go.dev/badge/github.com/ExploitSuite/req/v3.svg"></a>
        <a href="LICENSE"><img src="https://img.shields.io/github/license/ExploitSuite/req.svg" alt="License"></a>
        <a href="https://github.com/ExploitSuite/req/releases"><img src="https://img.shields.io/github/v/release/ExploitSuite/req?display_name=tag&sort=semver" alt="GitHub Releases"></a>
...
``` sh
go get github.com/ExploitSuite/req/v3
```
...
```go
import "github.com/ExploitSuite/req/v3"
```
...
:path: /uuid
:scheme: https
user-agent: req/v3 (https://github.com/ExploitSuite/req/v3)
...
func main() {
  ...
  resp, err := client.R().
    ...
    SetPathParam("username", "ExploitSuite"). // Replace path variable in url.
...
func main() {
	...
	resp, err := client.R().
		SetHeader("Accept", "application/vnd.github.v3+json"). // Chainable request settings
		SetPathParam("username", "ExploitSuite").
		SetSuccessResult(&userInfo). // Unmarshal response body into userInfo automatically if status code is between 200 and 299.
		Get("https://api.github.com/users/{username}")
...
func main() {
  ...
  resp, err := client.R().
    SetBody(&Repo{Name: "req", Url: "https://github.com/ExploitSuite/req"}).
...
{"name":"req","website":"https://github.com/ExploitSuite/req"}
...
{
  "args": {},
  "data": "{\"name\":\"req\",\"website\":\"https://github.com/ExploitSuite/req\"}",
  "files": {},
  "form": {},
  "headers": {
    "Accept-Encoding": "gzip",
  ...
  "json": {
    "name": "req",
    "website": "https://github.com/ExploitSuite/req"
  },
  "origin": "103.7.29.30",
...
++++++++++++++++++++++++++++++++++++++++++++++++
data: {"name":"req","url":"https://github.com/ExploitSuite/req"}
++++++++++++++++++++++++++++++++++++++++++++++++
```
...
If you have a bug report or feature request, you can [open an issue](https://github.com/ExploitSuite/req/issues/new), and [pull requests](https://github.com/ExploitSuite/req/pulls) are also welcome.

## Contact

If you have questions, feel free to reach out to us in the following ways:

* [Github Discussion](https://github.com/ExploitSuite/req/discussions)
* [Slack](https://ExploitSuite-req.slack.com/archives/C03UFPGSNC8) | [Join](https://slack.req.cool/)
